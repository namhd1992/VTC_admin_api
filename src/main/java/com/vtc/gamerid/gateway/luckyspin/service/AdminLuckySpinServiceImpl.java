...
public class AdminLuckySpinServiceImpl extends
    ...
    public LuckySpin toLuckySpin(AdSEventManagerBean spinEventManagerBean,
                                    LuckySpin luckySpin, 
        ...
        luckySpin.setName(spinEventManagerBean.getName());
        luckySpin.setType(spinEventManagerBean.getType());
        luckySpin.setKeyName(VNCharacterUtils.removeAccent(spinEventManagerBean.getName()));
        luckySpin.setImage(spinEventManagerBean.getImage());
        luckySpin.setCreateOn(new Date());
        luckySpin.setStartDate(spinEventManagerBean.getStartDate());
        luckySpin.setEndDate(spinEventManagerBean.getEndDate());
        luckySpin.setLastUpdate(new Date());
        luckySpin.setDescription(spinEventManagerBean.getDescription());
        luckySpin.setLinkLiveStream(spinEventManagerBean.getLinkLiveStream());
        luckySpin.setFreeSpinPerDay(spinEventManagerBean.getFreeSpinPerDay());
        luckySpin.setFreeSpinOnStart(spinEventManagerBean.getFreeSpinOnStart());
        luckySpin.setMaxSpinPerUser(spinEventManagerBean.getMaxSpinPerUser());
        luckySpin.setPricePerTurn(spinEventManagerBean.getPricePerTurn());
        luckySpin.setBuyTurnType(spinEventManagerBean.getBuyTurnType());
        luckySpin.setStatus(spinEventManagerBean.getStatus());
        luckySpin.setCreateBy(createBy);
        return luckySpin;
    }
