 ...
 */
@Component
public class AdminReportSpinFacadeImpl implements AdminReportSpinFacade {
    private Logger logger = LoggerFactory.getLogger(AdminReportSpinFacadeImpl.class);
    @Autowired
    ...
    public List<ResultReportSpinGetResponse> resultReportSpin(long luckySpinId, long startDateRequest, long endDateRequest) {
        ...
        for (String timeEvent : setTimeEvents) {
            ...
            List<ResultReportSpinGetResponseData> dataResponses = adminReportSpinService
